...
const DICT = {
  it: {
    ...
    'err.cors': 'il server risponde ma il browser blocca (CORS)',
    'err.apiSaid': 'l\'API risponde: {msg}', 'err.http': 'il server risponde HTTP {code}',
    ...
    'arr.reduced': '\u26A0 Scansione ampia non riuscita: mostro solo il raggio corrente ({nm} NM)',
  ...
  en: {
    ...
    'err.cors': 'server responds but browser blocks it (CORS)',
    'err.apiSaid': 'API says: {msg}', 'err.http': 'server replied HTTP {code}',
    ...
    'arr.reduced': '\u26A0 Wide scan failed: showing only the current radius ({nm} NM)',
